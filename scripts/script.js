...
let popupOpenPicture = document.querySelector(".popup_picture_full-screen");
// фото из попапа fullscreen
let popupOpenPictureItem = document.querySelector(".popup__picture");
...
popupEditProfile.addEventListener("submit", formSubmitEditProfile);
...
function addCardPlace (name, link) {
  ...
  placeDeleteCard(cardElement);
  placeLiketoggle(cardElement);
...
function placeDeleteCard (cardElement) {
...
// функция лайка
function placeLiketoggle (cardElement) {
